...
export const textContentSchema = defineKeySchema<FileUri, TextContent>("textContent");

export const loadTextContent = hostedQuery(textContentSchema, async (_, uri, ctx) => {
